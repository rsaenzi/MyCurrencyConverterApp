...
class ApiResponse {
    ...
    func successGetExchangeRates(response: Response<String, NSError>, onSuccess: callbackSuccessGetExchangeRates){
        ...
        // Success
        case 200:
            responseContainer = CurrencyConverter.app.control.jsonResponse.parseSuccessGetExchangeRates(jsonString)
        ...
        // Send Response
        CurrencyConverter.app.control.log.api.printResultInfo(responseContainer.responseCode.rawValue, responseMessage: responseContainer.responseMessage, responseAsJsonString: jsonString)
